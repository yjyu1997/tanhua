...
public class TestUserLocationApi {
    ...
    public void testQueryByUserId(){
        UserLocationDto userLocationDto = this.userLocationApi.queryByUserId(1L);
    ...
    public void testQueryUserFromLocation(){
        UserLocationDto userLocationDto = this.userLocationApi.queryByUserId(1L);
        PageInfo<UserLocationDto> pageInfo = this.userLocationApi
                .queryUserFromLocation(userLocationDto.getLongitude(),
                        userLocationDto.getLatitude(), 5000d, 1, 10);
